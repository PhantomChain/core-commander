...
menu_manage_commander_help ()
{
    ...
    text_white "    lets you configure the directory core is installed into when you select Install PhantomChain (you can change this before you start the core installation)."
    echo
